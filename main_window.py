...
from Master_copied import *
from tkinter import ttk

# Creating the Copier User InterFace program
_window = tk.Tk()
_window.title('Trade Copier beta - Server')
...
start_server_btn = tk.Button(lower_frame, text='Start Server', width=15, command=startServer, padx=10)
start_server_btn.grid(row=1, column=0, columnspan=2, padx=10, pady=5, sticky=tk.W)
